...
# --- Unit 0 ---
save_range(1, 10, "U0_Intro_Orientation.pdf")

# --- Unit 1: POVEȘTI DE TOAMNĂ ---
save_range(11, 11, "U1_Intro_Povesti_de_Toamna.pdf")
save_range(12, 14, "U1_L1_Ce_le_spun_cocorilor.pdf")
save_range(15, 15, "U1_L2_Sensul_cuvintelor.pdf")
save_range(16, 17, "U1_L3_In_biblioteca_scolii.pdf")
save_range(18, 19, "U1_L4_Comunicare.pdf")
save_range(20, 22, "U1_L5_Scrierea_creativa.pdf")
save_range(23, 25, "U1_Recapitulare_Evaluare.pdf")
...
save_range(41, 43, "U2_Recapitulare_Evaluare.pdf")
...
save_range(65, 67, "U3_Recapitulare_Evaluare.pdf")
...
save_range(82, 84, "U4_Recapitulare_Evaluare.pdf")
...
save_range(102, 105, "U5_Recapitulare_Evaluare.pdf")
...
save_range(122, 125, "U6_Recapitulare_Evaluare.pdf")
...
save_range(139, 143, "U7_Recapitulare_Evaluare.pdf")
...
save_range(155, 158, "U8_Recapitulare_Evaluare.pdf")
